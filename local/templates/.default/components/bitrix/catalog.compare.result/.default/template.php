...
/**
 * Стандартный компонент catalog.compare.result
 * Закомментировал строчки с выводом кнопок "Все характеристики" и  "Только различающиеся"
 * 44-60
 * Закомментировал строчки с проверкой $arResult['DIFFERENT'] тк всегда должны выводиться только разные характеристики
 * 215,216,230,340,341,355,383,384,398
 */
...
<!--		<div class="pr-2">-->
<!--			<small class="text-muted">--><?php //= GetMessage("CATALOG_SHOWN_CHARACTERISTICS") ?><!--:</small>-->
<!--		</div>-->
<!--		<div class="pr-2">-->
<!--			<a-->
...
<!--				rel="nofollow">--><?php //=GetMessage("CATALOG_ONLY_DIFFERENT")?><!--</a>-->
<!--		</div>-->
<!--	</div>-->
